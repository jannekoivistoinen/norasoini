// Shared styles
export const linkStyles = "text-black text-sm font-body transition";
export const linkStylesActive = "underline underline-offset-4";
export const descriptionStyles = "text-sm text-gray-500";

// Desktop styles
export const desktopLinkStyles = `${linkStyles} py-6 px-4 hover:opacity-60`;
export const desktopPopoverTriggerStyles = "flex items-center gap-1";
export const desktopPopoverContentStyles = "w-full p-0 pb-2 bg-brand-bg border-brand-bg";
...
export const desktopPopoverLinkTitleStyles = "text-[15px] font-medium text-black";
...
export const mobileLinkStylesActive = "underline underline-offset-4";
